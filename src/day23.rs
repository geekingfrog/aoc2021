...
fn move_all_pods(grid: Grid) -> usize {
    ...
    while let Some(Node(cost, grid)) = states.pop() {
        ...
        // if cost >= max_bound {
        //     // println!(
        //     //     "cost so far {} exceed max bound {} at depth {}",
        //     //     cost, max_bound, depth
        //     // );
        //     continue;
        //     // return 0;
        // }
        //
        // if grid.is_finished() {
        //     max_bound = max_bound.min(cost);
        //     println!("grid finished, new min cost is {}", max_bound);
        //     // return 0;
        //     continue;
        // }
        //
        ...
        //
        //         if c < max_bound {
        //             to_add.push((g, c, depth + 1));
        //             // println!(
        //             //     "adding {}({}) -> {}({})  for cost {}",
        //             //     idx,
        //             //     grid.points[idx].unwrap(),
        //             //     dest_idx,
        //             //     g.points[dest_idx].unwrap(),
        //             //     add_cost
        //             // );
        //         }
        //     }
        ...
        //
        // // if deadlocked {
        // //     println!("grid deadlocked\n{}", grid);
        // // }
        //
        // // to_add.sort_unstable_by(|a, b| a.1.cmp(&b.1));
        // // println!("adding: {:?}", to_add.iter().map(|x| x.1).collect::<Vec<_>>());
        // states.extend(to_add);
        // // if !to_add.is_empty() {
        // //     states.push(to_add[to_add.len()-1]);
        // // }
    }
    min_cost
}
