...
fn separate(c: &mut Criterion) {
    ...
    c.bench_function("day23", |b| b.iter(|| black_box(day23::solve())));
    c.bench_function("day24", |b| b.iter(|| black_box(day24::solve())));
    c.bench_function("day25", |b| b.iter(|| black_box(day25::solve())));
}
